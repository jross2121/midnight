...
export function normalizeResetDateKey(value: unknown, todayDateKey: string): string {
  if (!isValidDateKey(todayDateKey)) return localDateKey();
  return isValidDateKey(value) && value <= todayDateKey ? value : todayDateKey;
}
