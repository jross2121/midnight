...
export const defaultAchievements: Achievement[] = [
  ...
  { id: "first_contract", name: "Oathkeeper", description: "Protect every contract quest in a day", icon: "Oath", unlockedAt: null },
  { id: "contract_3", name: "Pledge Streak", description: "Protect contracts 3 judgment days in a row", icon: "Oath", unlockedAt: null },
  { id: "contract_7", name: "Iron Oath", description: "Protect contracts 7 judgment days in a row", icon: "Oath", unlockedAt: null },
  { id: "contract_14", name: "Unbroken Oath", description: "Protect contracts 14 judgment days in a row", icon: "Oath", unlockedAt: null },
